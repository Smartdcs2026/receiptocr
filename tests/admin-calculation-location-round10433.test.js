...
const calcPath=brandsHtml.includes('brand-calculation-round10434.js')?'web-admin/brand-calculation-round10434.js':'web-admin/brand-calculation-round10433.js';
const brandCalc=fs.readFileSync(calcPath,'utf8');
...
assert.ok(brandsHtml.includes('brand-calculation-round10434.js')||brandsHtml.includes('brand-calculation-round10433.js?v=104330'));
assert.ok(brandsHtml.includes('review-customer-trend-model-round10432.js?v=104321'));
assert.ok(brandCalc.includes('กติกาคำนวณ'));
assert.ok(brandCalc.includes('/api/admin/brand-receipt-rules'));
assert.ok(brandCalc.includes('reviewCalculation:r.value'));
assert.ok(brandCalc.includes('r34Start')||brandCalc.includes('rv32Start'));
assert.ok(brandCalc.includes('r34End')||brandCalc.includes('rv32End'));
assert.ok(brandCalc.includes('r34Percent')||brandCalc.includes('rv32Percent'));
assert.ok(brandCalc.includes('r34Same')||brandCalc.includes('rv32Same'));
...
console.log('Admin calculation settings remain on Admin brand page, not review page');
